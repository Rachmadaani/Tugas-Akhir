...
class EventController extends Controller
{
    ...
    public function store()
    {
        ...
        $data = [
            ...
            'nohp_panitia'  => $this->request->getPost('nohp_panitia'),
        ...
        // Upload tanda tangan panitia
        $ttdFile = $this->request->getFile('ttd_panitia');
        if ($ttdFile && $ttdFile->isValid() && !$ttdFile->hasMoved()) {
            $ttdName = $ttdFile->getRandomName();
            $ttdFile->move('assets/ttd_panitia/', $ttdName);
            $data['ttd_panitia'] = $ttdName;
        }
    ...
    public function update($id)
    {
        ...
        // Upload tanda tangan panitia baru jika ada
        $ttdFile = $this->request->getFile('ttd_panitia');
        if ($ttdFile && $ttdFile->isValid() && !$ttdFile->hasMoved()) {
            $ttdName = $ttdFile->getRandomName();
            $ttdFile->move('assets/ttd_panitia/', $ttdName);
