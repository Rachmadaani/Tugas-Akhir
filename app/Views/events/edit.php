                ...
                <div class="col-md-8">
                    <div class="card card-primary">
                        ...
                        <form action="<?= site_url('events/update/' . $event['id']); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <!-- Tambahan kolom Nama Panitia -->
                            <div class="form-group">
                                <label for="nama_panitia">Nama Panitia</label>
                                <input type="text" name="nama_panitia" class="form-control" value="<?= $event['nama_panitia']; ?>" required>
                            </div>

                            <!-- Tambahan kolom No HP Panitia -->
                            <div class="form-group">
                                <label for="nohp_panitia">No HP Panitia</label>
                                <input type="text" name="nohp_panitia" class="form-control" value="<?= $event['nohp_panitia']; ?>" required>
                            </div>
