...
//Certificates
$routes->get('user/certificates/preview/(:num)', 'UserController::previewCertificate/$1');
$routes->get('user/certificates/download/(:num)', 'UserController::downloadCertificate/$1');
$routes->post('user/certificates/preview/(:num)', 'UserController::previewCertificate/$1');
$routes->get('user/certificates/pdf/(:num)', 'UserController::pdfCertificate/$1');

// Downlaod PDF
$routes->get('user/pdfCertificate/(:num)', 'UserController::pdfCertificate/$1');

// Request Event
$routes->get('/event/request', 'RequestEvent::index');
$routes->post('/event/request/submit', 'RequestEvent::submit');
